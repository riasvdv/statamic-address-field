...
<template>
    <fieldset class="flex flex-col gap-2 border-grey-40 px-2 py-2 rounded m-0 relative">
      ...
      <div class="w-full" v-if="config.enabledFields.includes('name')">
      ...
      <div class="w-full" v-if="config.enabledFields.includes('street')">
      ...
      <div class="w-full" v-if="config.enabledFields.includes('street2')">
      ...
      <div class="flex gap-3">
        <div class="w-full" v-if="config.enabledFields.includes('postCode')">
        ...
        <div class="w-full" v-if="config.enabledFields.includes('city')">
      ...
      <div class="flex gap-3">
        <div class="w-full" v-if="config.enabledFields.includes('state')">
        ...
        <div class="w-full" v-if="config.enabledFields.includes('country')">
